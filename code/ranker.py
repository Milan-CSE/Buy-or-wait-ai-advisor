...
def make_decision(
    ...
    # wait and not_recommended methods never prescribe spending changes (waiting means
    # relying on scheduled income replenishment without cutting flexible expenses).
